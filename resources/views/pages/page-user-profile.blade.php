            ...
            <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
              ...
              <div class="card">
                <div class="card-content">
                  ...
                  {{ Form::open(['route' => ['admin.account.update',$user->id], 'enctype' =>'multipart/form-data', 'class' => 'js-form','method' => 'put']) }}
                  <div class="card-body">
                    ...
                    @if(!empty($user->profile->photo))
                      <img src="{{$user->profile->photo}}" class="img-thumbnail rounded-circle" width="200" style="height: 200px !important">
                    @else
                  ...
                  <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" data-validate-field="name" placeholder="Enter username" class="form-control" value="{{$user->name}}">
                            {!! $errors->first('name',
                    ...
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('email','Email') }}<span style="color: red;">*</span> {{ Form::email('email',old('email'),array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter Email Address' ,'data-validate-field' => 'email')) }} {!!
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('password','Password') }}<span style="color: red;">*</span> {{ Form::password('password', array('class'=>'form-control', 'style'=> 'margin-bottom:10px;','placeholder'=>'Enter New Password' ,'data-validate-field' => 'password')) }} {!!
                            $errors->first('password', '<label id="password-error" class="error" for="password">:message</label>') !!}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('phone','Phone') }}<span style="color: red;">*</span> {{ Form::number('phone',old('phone', (!empty($user->profile->phone)) ? $user->profile->phone : '' ),array('class'=>'form-control', 'style'=>
                            'margin-bottom:10px;','placeholder'=>'Enter Phone Number' ,'data-validate-field' => 'phone')) }} {!! $errors->first('phone', '<label id="name-error" class="error" for="name">:message</label>') !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('city','City') }}<span style="color: red;">*</span> {{ Form::text('city',old('city', (!empty($user->profile->city)) ? $user->profile->city : ''),array('class'=>'form-control', 'style'=>
                            'margin-bottom:10px;','placeholder'=>'Enter City Name' ,'data-validate-field' => 'city')) }} {!! $errors->first('city', '<label id="city-error" class="error" for="city">:message</label>') !!}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('country','Country') }}<span style="color: red;">*</span> {{ Form::text('country',old('country', (!empty($user->profile->country)) ? $user->profile->country : ''),array('class'=>'form-control', 'style'=>
                            'margin-bottom:10px;','placeholder'=>'Enter Country Name' ,'data-validate-field' => 'country')) }} {!! $errors->first('country', '<label id="country-error" class="error" for="country">:message</label>') !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            {{ Form::label('address','Address') }}<span style="color: red;">*</span> {{ Form::text('address',old('address', (!empty($user->profile->address)) ? $user->profile->address : ''), array('class'=>'form-control', 'style'=>
                            'margin-bottom:10px;','placeholder'=>'Enter Address' ,'data-validate-field' => 'address')) }} {!! $errors->first('address', '<label id="address-error" class="error" for="address">:message</label>') !!}
                        </div>
                    </div>
                </div>
                    ...
                    <button type="submit" class="btn btn-sm d-none d-sm-block float-right btn-light-primary mb-2">
                      Update
                    </button>
                  </div>
                  {{ Form::close() }}
